window.onload = function(){
    ...
    // Set Timer
    // Mengatur Timer
     var redTimer = check(10); // Time For Red Light, Waktu Untuk Lampu Merah
    var yelTimer = check(3);// Time For Yellow Light, Waktu Untuk Lampu Kuning5
    var greTimer = check(10);// Time For Green Light, Waktu Untuk Lampu Hijau
